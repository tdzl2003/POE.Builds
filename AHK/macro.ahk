...
Gui, 2:Add, Text,x5 y295, Logout:
Gui, 2:Add, Text,x5 y321, ForceLogout:
Gui, 2:Add, Text,x5 y347, /Oos:
Gui, 2:Add, Text,x5 y373, /Remaining :
Gui, 2:Add, Text,x5 y399, /whois :
Gui, 2:Add, Text,x5 y425, Travel to Hideout :
Gui, 2:Add, Text,x5 y451, Invite Player :
Gui, 2:Add, Text,x5 y477, Toggle Overlay Size:
Gui, 2:Add, Text,x5 y503, Price Check :
...
Gui, 2:Add, Text,x272 y455, Problem with the macro? Check
Gui, 2:Add, Text,x272 y477, Options (This GUI) :
...
Gui, 2:Add, Text,x435 y455,	http://lutbot.com/#/faq
...
Gui, 2:Add, Button, x530 y570 gchangelogGui, Changelog
Gui, 2:Add, Button, x600 y570 default gupdateHotkeys, Save
